#!/usr/bin/env python3
"""Run the OMeGa-4-Building depth+coplane regularized extension config."""
...
if __name__ == "__main__":
    ...
    if "--config" not in sys.argv:
        config_name = "geometry_regularized_from_warmup_6500.json" if from_warmup else "geometry_regularized_6500.json"
